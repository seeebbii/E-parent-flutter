...
class ManageAccountsModuleScreen extends StatefulWidget {
  const ManageAccountsModuleScreen({Key? key}) : super(key: key);

  @override
  State<ManageAccountsModuleScreen> createState() => _ManageAccountsModuleScreenState();
}

class _ManageAccountsModuleScreenState extends State<ManageAccountsModuleScreen> {
  @override
